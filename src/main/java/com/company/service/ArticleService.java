...
//        moderator.setId(profileId);
    ...
    public ArticleDTO get(ArticleEntity entity) {
        ArticleDTO dto = new ArticleDTO();
        dto.setUuid(entity.getId());
        return dto;
    }
...
//        dto.setId(entity.getId());
    ...
    public List<ArticleDTO> findTop5ArticlesByTyKey(String key) {


        List<ArticleEntity> articleList = articleRepository.findTop5ByArticleNat(key);
    ...
    public ArticleDTO shortDTOInfo(ArticleEntity article) {
        ...
        dto.setPhotoId(article.getPhoto().getId());
        return dto;
    }
    ...
    public List<ArticleDTO> getCategoryByPage(String key) {
        ...
        Page<ArticleEntity> articlePage = articleRepository.findLast5ByCategoryKey(key, ArticleStatus.PUBLISHED, page);
        List<ArticleDTO> dtoList = new LinkedList<>();
    ...
    public List<ArticleDTO> getLast5ArticleByType(String typeKey, String id) {
        List<ArticleShortInfo> articleList = articleRepository.findLast5ByType(typeKey, id);
    ...
    public PageImpl<ArticleDTO> getLast5ArticleByRegionKey(String regionKey, int page, int size) {
        ...
        Page<ArticleShortInfo> articlePage = articleRepository.findLast5ByRegionKey(regionKey, pageable);
    ...
    public List<ArticleDTO> filter(ArticleFilterDTO filterDTO) {
        ...
        filter.forEach(articleEntity -> {
            ...
            articleList.add(shortDTOInfo(articleEntity));
        });
